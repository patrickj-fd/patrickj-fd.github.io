...
su - hyren
python3 -m venv ~/python/venv/tf-1.13
cp ~/python/venv/tf-1.13/bin/activate ~/pyvenv-tf13
source ~/pyvenv-tf13
...
#python3 -m pip install h5py pandas
# wget -c https://www.piwheels.org/simple/pandas/pandas-1.0.5-cp37-cp37m-linux_armv7l.whl

# OpenCV3
# 下载地址：https://www.piwheels.org/simple/opencv-python/
python3 -m pip install opencv_python-3.4.11.45-cp37-cp37m-linux_armv7l.whl  # opencv_python-3.4.7.28-cp37-cp37m-linux_armv7l.whl
